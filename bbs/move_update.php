            ...
            $sql = " insert into $move_write_table
                        set wr_num            = '$next_wr_num',
                            ...
                            wr_9              = '".addslashes($row2[wr_9])."',
														...
														wr_21              = '".addslashes($row2[wr_21])."',
														wr_22              = '".addslashes($row2[wr_22])."',
														wr_23              = '".addslashes($row2[wr_23])."',
														wr_24              = '".addslashes($row2[wr_24])."',
														wr_25              = '".addslashes($row2[wr_25])."',
														wr_26              = '".addslashes($row2[wr_26])."',
														wr_27              = '".addslashes($row2[wr_27])."',
														wr_28              = '".addslashes($row2[wr_28])."',
														wr_29              = '".addslashes($row2[wr_29])."',
														wr_30              = '".addslashes($row2[wr_30])."',
														wr_31              = '".addslashes($row2[wr_31])."',
														wr_32              = '".addslashes($row2[wr_32])."',
														wr_33              = '".addslashes($row2[wr_33])."',
														wr_34              = '".addslashes($row2[wr_34])."',
														wr_35              = '".addslashes($row2[wr_35])."',
														wr_36              = '".addslashes($row2[wr_36])."',
														wr_37              = '".addslashes($row2[wr_37])."',
														wr_38              = '".addslashes($row2[wr_38])."',
														wr_39              = '".addslashes($row2[wr_39])."',
														wr_40              = '".addslashes($row2[wr_40])."',
														wr_41              = '".addslashes($row2[wr_41])."',
														wr_42              = '".addslashes($row2[wr_42])."',
														wr_43              = '".addslashes($row2[wr_43])."',
														wr_44              = '".addslashes($row2[wr_44])."',
														wr_45              = '".addslashes($row2[wr_45])."',
														wr_46              = '".addslashes($row2[wr_46])."',
														wr_47              = '".addslashes($row2[wr_47])."',
														wr_48              = '".addslashes($row2[wr_48])."',
														wr_49              = '".addslashes($row2[wr_49])."',
														wr_50              = '".addslashes($row2[wr_50])."',
														wr_51              = '".addslashes($row2[wr_51])."',
														wr_52              = '".addslashes($row2[wr_52])."',
														wr_53              = '".addslashes($row2[wr_53])."',
														wr_54              = '".addslashes($row2[wr_54])."',
														wr_55              = '".addslashes($row2[wr_55])."',
														wr_56              = '".addslashes($row2[wr_56])."',
														wr_57              = '".addslashes($row2[wr_57])."',
														wr_58              = '".addslashes($row2[wr_58])."',
														wr_59              = '".addslashes($row2[wr_59])."',
														wr_60              = '".addslashes($row2[wr_60])."',
														wr_61              = '".addslashes($row2[wr_61])."',
														wr_62              = '".addslashes($row2[wr_62])."',
														wr_63              = '".addslashes($row2[wr_63])."',
														wr_64              = '".addslashes($row2[wr_64])."',
														wr_65              = '".addslashes($row2[wr_65])."',
														wr_66              = '".addslashes($row2[wr_66])."',
														wr_67              = '".addslashes($row2[wr_67])."',
														wr_68              = '".addslashes($row2[wr_68])."',
														wr_69              = '".addslashes($row2[wr_69])."',
                            wr_70             = '".addslashes($row2[wr_70])."' ";
            sql_query($sql);
