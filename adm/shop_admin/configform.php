...
<tr class=ht>
	...
	<td colspan=3>
        ...
        &nbsp; 가능한 아이코드를 사용하십시오.  쏜다넷의 경우 utf-8 지원하지 않습니다.
	</td>
</tr>
<tr class=ht>
	<td>관리자 핸드폰번호</td>
...
<tr class=ht>
	<td>아이코드 서버 IP</td>
	<td colspan=3>
		<input type=text name=de_icode_server_ip value='<?=$default[de_icode_server_ip]?>' size=20 class=ed>
