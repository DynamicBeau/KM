...
var list_delete_php = "<?=$g4[admin_path]?>/popup.list.delete.php";
</script>
...
<tr class='bgcol1 bold col1 ht center'>
    ...
    <td><? echo "<a href='$g4[admin_path]/popup.form.php'><img src='$g4[admin_path]/img/icon_insert.gif' border=0 title='생성'></a>"; ?></td>
</tr>
...
for ($i=0; $row=sql_fetch_array($result); $i++) 
{
    ...
    $s_upd = "<a href='$g4[admin_path]/popup.form.php?$qstr&w=u&pp_id=$row[pp_id]'><img src='$g4[admin_path]/img/icon_modify.gif' border=0 title='수정'></a>";
    $s_del = "<a href=\"javascript:post_delete('popup.delete.php', '$row[pp_id]');\"><img src='$g4[admin_path]/img/icon_delete.gif' border=0 title='삭제'></a>";
