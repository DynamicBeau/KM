...
{
    $html_title .= " 수정";
    $pp = sql_fetch("select * from g4_popup where pp_id = '$pp_id'");
...
<p align=center>
    ...
    <input type=button class=btn1 value='  목  록  ' onclick="document.location.href='<?=$g4[admin_path]?>/popup.php?<?=$qstr?>';">
</form>
...
{		
		<? echo cheditor3('pp_content'); ?>
    f.action = "<?=$g4[admin_path]?>/popup.update.php";
    return true;
}
</script>
<?
