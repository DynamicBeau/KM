...
.board_list td { border-bottom:1px dotted #ddd; } 
...
<table width="<?=$width?>" align="center" cellpadding="0" cellspacing="0"><tr><td>
    ...
    <tr class="bg<?=$bg?>"> 
		...
		<td align="center"><?=$list[$i][wr_2]?><br><?=$list[$i][wr_1]?><br><?=$list[$i][wr_subject]?></td>
        <td>
            <? 
            echo "<a href='{$list[$i][href]}'>".cut_str($list[$i][wr_content],80,'...')."</a>";
            ?>
        </td>
		<td><?=$list[$i][wr_4]?></td>
    </tr>
