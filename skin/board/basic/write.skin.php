...
<tr>
    ...
    <td><input class='ed' style="width:100%;" name=wr_subject id="wr_subject" itemname="제목" required value="<?=$write[wr_subject]?>"></td></tr>
<tr><td colspan=2 height=1 bgcolor=#e7e7e7></td></tr>
<tr>
    <td class=write_head>연락처</td>
    <td><input class='ed' style="width:100%;" name="wr_1" id="wr_1" value="<?=$write[wr_1]?>"></td></tr>
<tr><td colspan=2 height=1 bgcolor=#e7e7e7></td></tr>
<tr>
    <td class=write_head>주소</td>
    <td><input class='ed' style="width:100%;" name="wr_2" id="wr_2" value="<?=$write[wr_2]?>"></td></tr>
<tr><td colspan=2 height=1 bgcolor=#e7e7e7></td></tr>
<tr>
    <td class=write_head>성 별</td>
    <td><input class='ed' style="width:100%;" name="wr_3" id="wr_3" value="<?=$write[wr_3]?>"></td></tr>
<tr><td colspan=2 height=1 bgcolor=#e7e7e7></td></tr>
<tr>
