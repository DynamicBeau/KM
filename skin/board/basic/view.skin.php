...
<tr>
    <td height=30 background="<?=$board_skin_path?>/img/view_dot.gif" style="color:#888;">
		...
		<tr>
		<td height=30 background="<?=$board_skin_path?>/img/view_dot.gif" style="color:#888888;">&nbsp;전화번호 : <?=$view[wr_1]?>
		</td>
		</tr>
		<tr>
		<td height=30 background="<?=$board_skin_path?>/img/view_dot.gif" style="color:#888888;">&nbsp;주 소 : <?=$view[wr_2]?>
		</td>
		</tr>

		<tr>
		<td height=30 background="<?=$board_skin_path?>/img/view_dot.gif" style="color:#888888;">&nbsp;성 별 : <?=$view[wr_3]?>
		</td>
		</tr>
