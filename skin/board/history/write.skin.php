...
<tr>
  ...
  <td colspan="2" class=write_head><table width="100%" border="0" cellspacing="0" cellpadding="0">

    <tr>

      <td><img src="<?=$board_skin_path?>/img/board_listL.gif" /></td>

      <td class="listC"><?=$title_msg?></td>

      <td><img src="<?=$board_skin_path?>/img/board_listR.gif" /></td>
...
<tr>
    ...
    <td><input class='ed' style="width:30%;" name="wr_subject" id="wr_subject" itemname="몇월" required="required" value="<?=$subject?>" />
...
<tr>
    ...
    <td style='padding:5 0 5 0;'>
        ...
        <textarea id="wr_content" name="wr_content" class=tx style='width:100%; word-break:break-all;' rows=1 itemname="내용" required 
...
<tr>
    ...
    <td class=write_head>관련 링크 #<?=$i?></td>
...
<tr>
    ...
    <td width="100%" align="center" valign="top" style="padding-top:30px;"><input name="image" type="image" id="btn_submit" accesskey='s' src="<?=$board_skin_path?>/img/btn_write_save.gif" border="0" />

      &nbsp; <a href="./board.php?bo_table=<?=$bo_table?>"><img id="btn_list" src="<?=$board_skin_path?>/img/btn_write_list.gif" border="0" /></a></td>
