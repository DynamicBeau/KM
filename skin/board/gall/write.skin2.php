...
<tr><td style='padding-left:20px' colspan=2 height=38 bgcolor=#287211><strong><?=$title_msg?></strong></td></tr>
<!-- 미경
<tr><td colspan=2 height=2 bgcolor=#b0adf5></td></tr>
<tr><td style='padding-left:20px' colspan=2 height=38 bgcolor=#287211><strong><?=$title_msg?></strong></td></tr>
-->
...
<tr>
    ...
    <td style='padding:5 0 5 0;'><table id="variableFiles" cellpadding=0 cellspacing=0><input type='file' class=ed size=32 name='bf_file[]' required itemname='파일' title='파일 용량 <?=$upload_max_filesize?> 이하만 업로드 가능'></table><?// print_r2($file); ?>
        <script language="JavaScript">
        var flen = 0;
