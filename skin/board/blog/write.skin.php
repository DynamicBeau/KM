...
<div style="width:630px; height:24px; font-weight:bold; font-size:18px; padding:10px; border:1px solid #eee;">:: <?=$title_msg?> ::</div>
...
<tr>
    ...
    <td><input class='ed' style="width:90%;" name=wr_subject id="wr_subject" itemname="제목" required value="<?=$subject?>"></td></tr>
<tr><td colspan=2 height=1 bgcolor=#e7e7e7></td></tr>
<tr>
