...
<tr>
    <td class=write_head>효과설정</td>
    <td>
		<select name='wr_1' style="background-color:#f6f6f6; border:1px solid #7f9db9; height:21px;">
			...
			<option value='breatheBlur'>breatheBlur</option>
		</select>
		&nbsp;최신글 효과가 적용됩니다.</td>
</tr>
<tr><td colspan=2 height=1 bgcolor=#e7e7e7></td></tr>
