    ...
    <td width='100%'>
        ...
        <tr>
            <td valign=top>
                ...
                <span style="font: 10px tahoma; color:#909090;"><?=date("F j, Y", strtotime($list[$i][wr_datetime]))?></span>
                </div>
                <div style="float:right; margin-top:1px;">
                <? if ($is_ip_view) { echo "&nbsp;<span style=\"font: 10px tahoma; color:#909090;\">{$list[$i][ip]}</span>"; } ?>
