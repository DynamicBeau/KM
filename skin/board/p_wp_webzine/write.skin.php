...
<style type="text/css">
.write_head { height:30px; text-align:center; color:#a7a7a7; font-family:'Malgun Gothic',돋움,Arial; font-weight:normal; font-size:12px; }
...
<div style="font-family:'Malgun Gothic',돋움,Arial; font-weight:bold; font-size:18px; margin:7px 0 0 5px;">작성 & 사진 업로드</div>
</div>
...
<tr>
    <td width="100%" align="center" valign="top" style="padding-top:30px;">
        ...
        <a href="./board.php?bo_table=<?=$bo_table?>"><img id="btn_list" src="<?=$board_skin_path?>/img/btn_cancel.gif" border=0></a></td>
</tr>
</table>
