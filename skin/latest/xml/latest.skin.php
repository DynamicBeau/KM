...
$img_x = '535'; //큰 썸네일 가로길이 
$img_y = '252'; //큰 썸네일 세로길이
...
$get_xml  .= "<config>";
$get_xml  .= "<roundCorner>3</roundCorner>";
$get_xml  .= "<autoPlayTime>5</autoPlayTime>";
...
$get_xml  .= "<btnSetMargin>auto 15 15 auto</btnSetMargin>";
$get_xml  .= "<btnDistance>20</btnDistance>";
$get_xml  .= "<titleBgColor>0xff6600</titleBgColor>";
$get_xml  .= "<titleTextColor>0xffffff</titleTextColor>";
$get_xml  .= "<titleBgAlpha>.99</titleBgAlpha>";
$get_xml  .= "<titleMoveDuration>1</titleMoveDuration>";
$get_xml  .= "<btnAlpha>.7</btnAlpha>";
$get_xml  .= "<btnTextColor>0xffffff</btnTextColor>";
$get_xml  .= "<btnDefaultColor>0x1B3433</btnDefaultColor>";
$get_xml  .= "<btnHoverColor>0xff9900</btnHoverColor>";
$get_xml  .= "<btnFocusColor>0xff6600</btnFocusColor>";
