...
<style type="text/css">
.write_head { height:30px; text-align:left; color:#29517b; font-weight:bold;}
...
<colgroup width=90>
<colgroup width=''>
<tr><td colspan="2" height=1 bgcolor=959595></td></tr>

<tr>
    <td class=write_head> · 지원자 이름</td>
...
<tr>
    <td class=write_head> · 지원자 이메일</td>
...
<tr>
    <td class=write_head> · 지원자 연락처</td>
    <td><input class='ed' style="500px;" name=wr_subject id="wr_subject" itemname="연락처" required value="<?=$subject?>"> 연락받으실 수 있는 전화번호를 입력해 주세요.</td></tr>
<tr><td colspan=2 height=1 bgcolor=#e7e7e7></td></tr>
<tr>
...
<tr>
    ...
    <td style='padding:5 0 5 0;'><table id="variableFiles" border=0 cellpadding=0 cellspacing=0></table><?// print_r2($file); ?> 
        <script type="text/javascript">
        var flen = 0;
