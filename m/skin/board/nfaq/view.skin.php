...
<table width="<?=$width?>" align="center"  border=0 cellpadding="0" cellspacing="0"><tr><td>
    ...
    <tr>
        <td height=30 bgcolor=f9f9f9 colspan=2>
	...
	<tr><td height=30 colspan=2>    <img src="<?=$board_skin_path?>/img/icon_date.gif" align=absmiddle border='0'>
    <span style="color:#888888;">작성일 : <?=date("y-m-d H:i", strtotime($view[wr_datetime]))?></span></td></tr>
...
//function image_window(vv){return;}
</script>
<!-- 게시글 보기 끝 -->
