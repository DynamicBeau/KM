...
<tr>
    <td><img src="<?=$member_skin_path?>/img/join_form_title.gif" >
...
<tr>
	...
	<TR bgcolor="#FFFFFF">
		<td width="160" class=m_title>회원유형</td>
		<td class=m_padding>
			<input class=ed type="radio" name="mb_mb" value="일반회원">일반회원
			<input class=ed type="radio" name="mb_mb" value="업체회원">업체회원
			<TR bgcolor="#FFFFFF">
			</td>
			<!--회원유형 끝-->
        <TABLE cellSpacing=1 cellPadding=0 width=100%>
...
<tr>
    <td bgcolor="#CCCCCC">
        ...
        <TR bgcolor="#FFFFFF">
            ...
            <TD class='m_padding lh'>
								<input name="mb_email1" id="mb_email1" class="ed" type="text" value="<?=$mb_mail[0]?>"  title="이메일ID입력" style="width:90px;" class="ed" itemname="이메일ID입력" required/>
								@ 
								<input name="mb_email2" id="mb_email2" class="ed" type="text" value="<?=$mb_mail[1]?>"  title="이메일서비스입력" />
        ...
        <TR bgcolor="#FFFFFF">
            ...
            <TD class=m_padding>
						<input class=ed type=text name='mb_tel' size=21 maxlength=20 <?=$config[cf_req_tel]?'required':'';?> itemname='전화번호' value='<?=$member[mb_tel]?>'></TD>
        </TR>
        <? } ?>
        ...
        <TR bgcolor="#FFFFFF">
					...
					<TD class=m_padding>
					<select id="mb_hp1" name="mb_hp1" class="ed" <?=$config[cf_req_hp]?'required':'';?> itemname="핸드폰번호">
					...
					<script>fregisterform.mb_hp1.value = '<?=$mb_hp[0]?>';</script>
					- 
					<input name="mb_hp2" id="mb_hp2" type="text" maxlength="4" value="<?=$mb_hp[1]?>" <?=$config[cf_req_hp]?'required':'';?> itemname="핸드폰국번"  style='width:50px;'/>
					- 
					<input name="mb_hp3" id="mb_hp3" type="text" maxlength="4" value="<?=$mb_hp[2]?>" <?=$config[cf_req_hp]?'required':'';?> itemname="핸드폰뒤네자리" style='width:50px;'/>

					<input class=ed type=hidden id='mb_hp' name='mb_hp' size=21 maxlength=20 <?=$config[cf_req_hp]?'required':'';?> itemname='핸드폰번호' value='<?=$member[mb_hp]?>'>
					</TD>
        </TR>
        <? } ?>
...
/*=========================자바스크립트 추가=====================================*/
//$("input").css({'height':'26px','font-size':'11pt'});

$("input").focus(function(){
	$(this).css("border","2px solid #66a2c8");
});

$("input").blur(function(){
	$(this).css({'border':'1px solid #d8d8d8','border-left': '1px solid #9a9a9a', 'border-top': '1px solid #9a9a9a'})
});
...
$('#mb_hp1').change(function(){ mb_hp_plus(); });
$('#mb_hp2').blur(function(){ mb_hp_plus(); });
$('#mb_hp3').blur(function(){ mb_hp_plus(); });
...
function chk(ff){
	...
	for(i=0;i<ff.mb_mb.lenght;i++){
		if(ff.mb_mb[i].checked){
			str=ff.mbmb[i].value;
			radioFlag=true;
			break;
		}
