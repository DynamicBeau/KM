...
.left_menu, .left_menu ul {padding:0; margin:0; list-style:none; background:url('<?=$g4[path]?>/images/left_box.png' ) no-repeat left top; margin-top:60px; margin-left:-10px;}
.left_menu {margin-left:25px;} /* this demo only */
.left_menu {width:210px; height:326px; border:0px solid #ddd;  position:relative; padding-top:90px; padding-left:0px; z-index:1; }
...
.left_menu li {width:180px; float:left; border-right:0px solid #ddd; text-indent: 10px; height:30px; line-height:10px; }
