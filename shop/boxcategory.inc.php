...
<tr><td align=left valign=top height=50 style='padding-top:5px;'><img src='<?=$g4[shop_img_path]?>/bar_category.gif'></td></tr>
<?
// 1단계 분류 판매가능한것만
...
for ($i=0; $row=sql_fetch_array($hresult); $i++)
{
    ...
    {
        $menubody .= "<tr height='22'><td style='font-family:Arial;'>&nbsp;&nbsp; <a href='$g4[shop_path]/list.php?ca_id=$row2[ca_id]'>$row2[ca_name]</a></td></tr>";
        // 맨밑줄은 출력하지 않음
        if ($j < $hnum2){
    ...
    echo "<td height='22' style='line-height:210%;font-size:14px;font-family:Arial;'>&nbsp;&nbsp; $category_link$row[ca_name]</a>\n";
    ...
    if ($menubody) 
    {
        ...
        echo "<table cellspacing=0 style='background:#cccccc;' width=100% class='111213'><tr><td>";
