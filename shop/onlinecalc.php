...
<div  class="page_title"><img src="<?=$g4[shop_img_path]?>/top_onlinecalc.gif" border=0></div>
...
<tr>
    <td>
        ...
        for ($i=0; $i<count($cat); $i++)
        {
            ...
            echo "<td>\n";
            echo "<select id='it_id_{$i}' name='it_id[{$i}]'  class='selectbox' style='width:350px;' onchange=\"compute_line(this.form, $i);\">\n";
