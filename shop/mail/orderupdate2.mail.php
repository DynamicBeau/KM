       ...
       <!-- 주문자 정보 -->
        <table width="95%" align="center" cellpadding="0" cellspacing="0">
        	<tr>
                ...
                <td align=right valign=bottom style='color:#A26217; font-size=11px; font-family:돋움'>상세한 내용은 주문서 조회 화면에서 확인하실 수 있습니다.  [<a href='<?="$g4[shop_url]/orderinquiry.php"?>'>바로가기</a>]</td>
            </tr>
            <tr>
                <td colspan=2>
                    <table width="100%" cellpadding="4" cellspacing="0">
        ...
        <tr>
            ...
            <td align=right valign=bottom style='color:#A26217; font-size=11px; font-family:돋움'>배송지를 변경하실 고객님은 <B><?= $default[de_admin_company_tel] ?></B>로 연락주시기 바랍니다.</td></tr>
        <tr>
            <td colspan=2>
                <table width="100%" cellpadding="4" cellspacing="0">
                <colgroup width=110>                    
