...
$od = sql_fetch(" select * from $g4[yc4_order_table] where od_id = '$od_id' and on_uid = '$on_uid' and od_cash = '1' ");
if (!$od) 
    die("주문서가 존재하지 않습니다.");
...
$Retailer_id = trim($default[de_allthegate_mid]);       //상점아이디

$Ord_No = trim($od[od_id]);             //주문번호

$Amtcash = trim($amt_tot);              //거래금액

$deal_won = trim($amt_sup);         //공급가액

$Dealno = trim($od[od_id]);             //거래고유번호

$Cust_no = trim($od[mb_id]);                //회원아이디

//$Cat_id = trim($_POST["Cat_id"]);             //단말기번호

$Resp_msg = trim("휴대전화,카드번호는");            //응답메시지

$Alert_msg1 = trim("http://현금영수증.kr에");       //알림메세지1

$Alert_msg2 = trim("등록! 문의:1544-2020");     //알림메세지2

$Adm_no = trim($od["od_cash_allthegate_adm_no"]);               //승인번호

$Amttex = trim($amt_tax);               //부가가치세

$Amtadd = trim($amt_svc);               //봉사료

$prod_nm = trim($goods_name);               //상품명

//$prod_set = trim($_POST["prod_set"]);         //상품갯수

$Gubun_cd = trim($od["od_cash_allthegate_gubun_cd"]);           //거래자구분    01.소득공제용 02.지출증빙용

$Confirm_no = trim($od["od_cash_allthegate_confirm_no"]);       //신분확인번호

$Pay_kind = trim("cash-appr");          //결제종류

$Success = trim("y");               //성공여부 y,n 으로 표시

$Pay_type = trim("1");          //결제방식 1.무통장임금 2.계좌이체
...
<!---------현금영수증 구분에 따른 이미지 표시------>
    <TR id="Display1" STYLE="display:none;">
        <td><IMG SRC="<?=$g4[shop_path]?>/img/allthegate/title_cash_pay_02.gif"></td>
    </tr>
    <TR id="Display2" STYLE="display:'';">
        <td><IMG SRC="<?=$g4[shop_path]?>/img/allthegate/cash_pay_01.gif"></td>
    </tr>
<!---------현금영수증 구분에 따른 이미지 표시------>
    <tr>
                             ...
                             <tr>
                                <td>
                                    ...
                                    <table width="400" border="0" cellpadding="2" cellspacing="2" bgcolor="#FFFFFF">
                                         ...
                                         <tr bgcolor="#FFFFFF"> 
                                            <td width="120" height="22" bgcolor="E3E9EC" class=font style="padding-left:10px;"><font color=053961>상점명(회사명)</td>
                                            <td bgcolor="ECF2F6" class=font style="padding-left:10px;"><?=$default[de_admin_company_name]?></td>
                                        </tr>

                                         <tr bgcolor="#FFFFFF"> 
                                            <td height="22" bgcolor="E3E9EC" class=font style="padding-left:10px;"><font color=053961>사업자등록번호</td>
                                            <td bgcolor="ECF2F6" class=font style="padding-left:10px;"><?=$default[de_admin_company_saupja_no]?></td>
                                        </tr>

                                         <tr bgcolor="#FFFFFF"> 
                                            <td height="22" bgcolor="E3E9EC" class=font style="padding-left:10px;"><font color=053961>대표자명</td>
                                            <td bgcolor="ECF2F6" class=font style="padding-left:10px;"><?=$default[de_admin_company_owner]?></td>
                                        </tr>
                                         <tr bgcolor="#FFFFFF"> 
                                            <td height="22" bgcolor="E3E9EC" class=font style="padding-left:10px;"><font color=053961>주 소</td>
                                            <td bgcolor="ECF2F6" class=font style="padding-left:10px;"><?=$default[de_admin_company_addr]?></td>
                                        </tr>
                                         <tr bgcolor="#FFFFFF"> 
                                            <td height="20" bgcolor="E3E9EC" class=font style="padding-left:10px;"><font color=053961>대표전화</td>
                                            <td bgcolor="ECF2F6" class=font style="padding-left:10px;"><?=$default[de_admin_company_tel]?></td>
                                        </tr>
                ...
                <tr>
                    <td>
                        ...
                        <table width="400" border="0" cellpadding="0" cellspacing="0">
                             ...
                             <tr>
                                <td width=35 height=27 class=td_title align=right style="padding-right:10px;"><img src="<?=$g4[shop_path]?>/img/allthegate/icon_arroe2.gif"></td>
                                <td width=66 class=td_title02>상품명</td>
                                <td width=299 class=td_body02><?=$prod_nm?></td>
                            </tr>

                             <!-- <tr>
                                <td height=27 class=td_title align=right style="padding-right:10px;"><img src="<?=$g4[shop_path]?>/img/allthegate/icon_arroe2.gif"></td>
                             ...
                             <tr>
                                ...
                                <td class=td_body02><?=number_format($Amtcash)?>원</td>
                            </tr>
...
<!------------------------------승인시 취소시 금액표시법 다름------------------------->
                ...
                <tr>
                    <td>
                        ...
                        <table width="400" border="0" cellpadding="0" cellspacing="0">
                             <tr>
                                <td colspan=3 background="<?=$g4[shop_path]?>/img/allthegate/bg_dot.gif" height=1></td>
                            </tr>
...
<? if ($Gubun_cd == "01")   { 
?>                   <tr bgcolor=#EFF2F4>
                                <td width=30 height=30 align=center><img src="<?=$g4[shop_path]?>/img/allthegate/icon_nemo.gif"></td>
...
<!------------------------------영수증 발행과 취소에 따른 구분 표시 ---------------------------------------------------------->
                ...
                <tr>
                    <td>
                        ...
                        <tr>
                            <td width=10><img src="<?=$g4[shop_path]?>/img/allthegate/icon_arrow.gif"></td>
    ...
    <tr>
        <td bgcolor=#E4E4E5 height=40 align=right>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0">
                             <tr>
                                <td><IMG SRC="<?=$g4[shop_path]?>/img/allthegate/btn_print.gif" onclick="javascript:jsPrint();" style="cursor:pointer;"></td>
                                <td width=20></td>
                                <td><IMG SRC="<?=$g4[shop_path]?>/img/allthegate/btn_close.gif" onclick="self.close();" style="cursor:pointer;"></td>
                                <td width=20></td>
                            </tr>
                        </table>
